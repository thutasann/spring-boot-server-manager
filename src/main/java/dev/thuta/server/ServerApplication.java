package dev.thuta.server;

import dev.thuta.server.model.Server;
import dev.thuta.server.repo.ServerRepo;
import org.springframework.boot.CommandLineRunner;
import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;
import org.springframework.context.annotation.Bean;

import static dev.thuta.server.enumeration.Status.SERVER_DOWN;
import static dev.thuta.server.enumeration.Status.SERVER_UP;
